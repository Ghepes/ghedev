...
import ghedev, {markdown, mdx, text, html} from '../index.js'
...
test('ghedev()', function (t) {
  ...
  t.deepEqual(markdown, ghedev, 'markdown is an alias of ghedev')
